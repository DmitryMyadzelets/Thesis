...
\begin{figure}[th]
	...
	\caption{Automaton of a valve with two sensors (open and close)}
...
\begin{figure}[!ht]
	...
	\caption{Automaton of a valve with actuator}
...
correspondent inference diagram is shown in the Figure
