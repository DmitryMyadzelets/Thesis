...
Automaton model of a double actuation device is depicted in the Figure
\ref{fig:lib_act}. Actually, it has two actuating parts, denoted in the figure
by  prefixes $a$ and $b$. Each actuating part is equal to two-state digital
component model. In the composition of these two components simultaneous $hi$
state is forbidden, i.e. $a\_hi \Rightarrow b\_lo$ and $b\_hi \Rightarrow
a\_lo$.
