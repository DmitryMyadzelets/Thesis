...
are correspondent to digital signal states as shown in the table
...
\begin{figure}[t]
	\centering
	\includegraphics[scale=0.7]{relay.pdf}
...
\begin{figure}[t]
	\centering
	\includegraphics[scale=0.7]{relay_f0}
...
e.g. broken coil. The correspondent model of the relay with this failure is
