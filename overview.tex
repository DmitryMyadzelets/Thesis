...
correspondent model, i.e. how the quality and quantity of information provided
...
design and its online failures monitoring during its operation. The following
chapter describes a formal theoretical framework for discrete event systems,
a model based approach for manufacturing systems design suitable for formal
analysis, and how failures of systems can be modeled in the context of this
approach formally.
