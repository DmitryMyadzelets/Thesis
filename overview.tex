...
and to evaluate them is the Failure Mode and Effects Analysis (FMEA). 
...
with a brief description of the FMEA as a pure industrial approach,
and formal methods as an academic response to the problem of failures diagnosis.
...
While FEMA is the first step of a system reliability study, the formal methods
augment \ldots
