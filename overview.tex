...
processes. It specifies the system's behaviour in a not strictly semantically
...
interpretation by humans ensuring that the system will behave explicitly as it
was specified.
